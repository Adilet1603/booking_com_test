...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('store', '0002_alter_product_product_videos'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='rating',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rating_product', to='store.product'),
        ),
        migrations.AlterField(
